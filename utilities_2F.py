...
def crear_DataFrame_Desbalance_Tension(dataFrame: pd.DataFrame, val_Desb_Ten: float):
    ...
    Returns:
        pd.DataFrame: Un nuevo DataFrame con las modificaciones aplicadas.
    """
    lista_Columnas_a_Promediar = ['Tensin L1', 'Tensin L2']
...
def crear_DataFrame_Desbalance_Corriente(dataFrame: pd.DataFrame, val_Desb_Corr: float):
    ...
    Returns:
        pd.DataFrame: Un nuevo DataFrame con las modificaciones aplicadas.
    """
    lista_Columnas_a_Promediar = ['Corriente L1', 'Corriente L2']
    ...
    listado_Columnas_a_Comparar = ['Corriente L1', 'Corriente L2']
...
def crear_Medidas_DataFrame_Tension(dataFrame: pd.DataFrame):
    ...
    columnas_var_Tabla_Tensiones: list = ['Tensin mn. L1', 'Tensin L1', 'Tensin mx. L1', 'Tensin mn. L2', 'Tensin L2', 'Tensin mx. L2']
...
def crear_Medidas_DataFrame_DesbTension(dataFrame: pd.DataFrame):
    ...
    """
    #Selecciona las columnas de la siguiente lista, aplicándolo al DataFrame que contiene TODAS las columnas de Tensión
    columnas_var_Tabla_DesbTension: list = ['Tensin L1', 'Tensin L2', 'Promedio', 'delta_V1', 'delta_V2', 'Desbalance']
...
def crear_Medidas_DataFrame_Corriente(dataFrame: pd.DataFrame):
    ...
    """
    #Selecciona las columnas de la siguiente lista, aplicándolo al DataFrame que contiene TODAS las columnas de Tensión
    columnas_var_Tabla_Corriente: list = ['Corriente mn. L1', 'Corriente L1', 'Corriente mx. L1', 'Corriente mn. L2', 'Corriente L2', 'Corriente mx. L2', 'Corriente de neutro mn.', 'Corriente de neutro', 'Corriente de neutro mx.']
...
def crear_Medidas_DataFrame_DesbCorriente(dataFrame: pd.DataFrame):
    ...
    """
    #Selecciona las columnas de la siguiente lista, aplicándolo al DataFrame que contiene TODAS las columnas de Tensión
    columnas_var_Tabla_DesbCorriente: list = ['Corriente L1', 'Corriente L2', 'Promedio', 'max_Corrientes_Medias', 'Desbalance']
...
def crear_Medidas_DataFrame_Distorsion_Tension(dataFrame: pd.DataFrame):
    ...
    """
    # Selecciona las columnas de la siguiente lista, aplicándolo al DataFrame que contiene TODAS las columnas de Tensión
    columnas_var_Tabla_DistorsionTension: list = ['V THD/d Mx. L1', 'V THD/d Mx. L2', 'var_Ref_Distorsion_Tension']
...
def crear_Medidas_DataFrame_Armonicos_DistTension(dataFrame: pd.DataFrame):
    ...
    columnas_var_Tabla_Armonicos_DistorsionTension: list = ['Arm. tensin 3 L1', 'Arm. tensin 5 L1', 'Arm. tensin 7 L1', 'Arm. tensin 9 L1', 'Arm. tensin 11 L1', 'Arm. tensin 13 L1', 'Arm. tensin 15 L1', 'Arm. tensin 3 L2', 'Arm. tensin 5 L2', 'Arm. tensin 7 L2', 'Arm. tensin 9 L2', 'Arm. tensin 11 L2', 'Arm. tensin 13 L2', 'Arm. tensin 15 L2']
...
def crear_Medidas_DataFrame_Distorsion_Corriente(dataFrame: pd.DataFrame):
    ...
    columnas_var_Tabla_DistorsionCorriente: list = ['A THD/d L1', 'A THD/d L2']
...
def crear_Medidas_DataFrame_Armonicos_DistCorriente(dataFrame: pd.DataFrame):
    ...
    columnas_var_Tabla_Armonicos_DistorsionCorriente: list = ['Arm. corriente 3 L1', 'Arm. corriente 5 L1', 'Arm. corriente 7 L1', 'Arm. corriente 9 L1', 'Arm. corriente 11 L1', 'Arm. corriente 13 L1', 'Arm. corriente 15 L1', 'Arm. corriente 3 L2', 'Arm. corriente 5 L2', 'Arm. corriente 7 L2', 'Arm. corriente 9 L2', 'Arm. corriente 11 L2', 'Arm. corriente 13 L2', 'Arm. corriente 15 L2']
...
def crear_Medidas_DataFrame_FactorK(dataFrame: pd.DataFrame):
    ...
    columnas_var_Tabla_FactorK: list = ['Factor K mn. L1', 'Factor K L1', 'Factor K mx. L1', 'Factor K mn. L2', 'Factor K L2', 'Factor K mx. L2']
...
def crear_Medidas_DataFrame_CargabilidadTDD(dataFrame: pd.DataFrame):
    ...
    columnas_var_Tabla_CargabilidadTDD: list = ['resultado_TDD_L1', 'resultado_TDD_L2']
