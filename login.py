    ...
    data = { 
      'Messages': [ 
                    { 
                        ...
                        "Subject": "Código de Autenticación | Circuitor App", 
                        "TextPart": mensaje, 
...
def validarPagina(pagina,usuario):
    ...
    dfPaginas = query_to_df("SELECT * FROM info_paginas_circuitor;")
...
def generarMenuRoles(usuario):
    ...
    with st.sidebar: # Menú lateral
        ...
        dfusuarios = query_to_df("SELECT * FROM viewinfousuarios;")
        dfPaginas = query_to_df("SELECT * FROM info_paginas_circuitor ORDER BY id_pagina ASC;")
